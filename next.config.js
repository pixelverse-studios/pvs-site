        ...
        headers: [
          ...
          },
          {
            ...
            value:
              ...
              "font-src 'self' data:; " +
              `connect-src 'self' https://www.google-analytics.com https://*.sentry.io https://*.supabase.co https://calendly.com https://*.calendly.com https://maps.googleapis.com https://maps.gstatic.com https://pvs-server-62hx7.ondigitalocean.app${process.env.NODE_ENV === 'development' ? ' http://localhost:5001' : ''}; ` +
