...
export const homepageFaq: FaqItem[] = [
  ...
  {
    question: 'What\u2019s the difference between your two services?',
    answer:
      'Web Design & Development is for businesses that need a new site or a rebuild. Local Optimization & SEO is for businesses with an existing site that want stronger local visibility and better conversion. We help determine which path fits your situation during the initial conversation.',
  },
  {
