...
export const cityServicePages: CityServicePageDefinition[] = [
  {
    ...
    serviceHighlights: [
      ...
      },
      {
        ...
        summary: 'High-converting layouts tested across mobile, desktop, and tablet experiences.',
        localAngle:
  ...
  },
  {
    ...
    hero: {
      ...
      stat: {
        ...
        value: 'Step 1',
        label:
          'Build landing clusters for salons, wellness providers, and home service pros so they show up for neighborhood searches from day one',
      },
      neighborhoods:
  ...
  },
  {
    ...
    serviceHighlights: [
      {
        serviceTitle: 'Custom Web Design & Development',
        summary: 'Built-in trust markers, service area explorers, and lightning-fast performance.',
        localAngle:
      ...
      {
        serviceTitle: 'Performance & Analytics',
        summary: 'Track form submissions, calls, and downloads per neighborhood and campaign.',
        localAngle:
  ...
  },
  {
    ...
    faq: [
      ...
      {
        question:
          'Do you handle website design and local SEO for Paramus, NJ retailers and service brands?',
        answer:
      ...
      {
        question:
          'How do you help Paramus businesses compete with big-box retailers and national chains?',
        answer:
  ...
  },
  {
    ...
    serviceHighlights: [
      ...
      {
        serviceTitle: 'UX & UI Design',
        summary: 'Multilingual, mobile-first flows for families, caregivers, and administrators.',
        localAngle:
    ...
    proof: {
      headline:
        'Teaneck organizations trust PixelVerse to balance civic expectations with growth goals.',
      ...
      stat: {
        value: '41%',
        label:
          'increase in inquiry-to-appointment rates after launching multilingual Teaneck landing flows',
      },
    },
    faq: [
      {
  ...
  },
  {
    ...
    serviceHighlights: [
      ...
      {
        serviceTitle: 'UX & UI Design',
        summary: 'Task-focused flows for operators, office staff, and on-the-go customers.',
        localAngle:
      ...
      {
        serviceTitle: 'Performance & Analytics',
        summary: 'Dashboards linking phone calls, form fills, and job tickets to campaigns.',
        localAngle:
          'See how Route 208 billboards, NJ Transit ads, or Google Ads influence lead quality and close rates.',
      },
      {
        serviceTitle: 'Ongoing Support & Updates',
        summary: 'Retainers for promo launches, catalog refreshes, and hiring pushes.',
        localAngle:
  ...
  },
  {
    ...
    serviceHighlights: [
      ...
      {
        serviceTitle: 'UX & UI Design',
        summary: 'Premium interfaces mixing refined typography, motion, and conversion cues.',
        localAngle:
      ...
      {
        serviceTitle: 'Ongoing Support & Updates',
        summary: 'Rapid experimentation for product launches, offer testing, and PR amplification.',
        localAngle:
  ...
  },
  {
    ...
    serviceHighlights: [
      {
        serviceTitle: 'Custom Web Design & Development',
        summary: 'Modular sections highlighting services, financing, and bilingual support.',
        localAngle:
          'Helps Bergenfield clinics, contractors, and schools surface the exact info households need before calling.',
      },
      {
        serviceTitle: 'UX & UI Design',
        summary: 'Adaptive layouts for heavy mobile traffic and screen-reader compatibility.',
        localAngle:
      ...
      {
        serviceTitle: 'Performance & Analytics',
        summary: 'Call tracking, form attribution, and intent tagging segmented by neighborhood.',
        localAngle:
          'See how Dumont, New Milford, or Tenafly spillover converts so you can prioritize offers.',
      },
      {
        serviceTitle: 'Ongoing Support & Updates',
        summary: 'Seasonal refreshes, promotion swaps, and review velocity programs.',
        localAngle:
  ...
  },
  {
    ...
    serviceHighlights: [
      ...
      {
        serviceTitle: 'UX & UI Design',
        summary: 'Elegant motion, typography, and micro-interactions without sacrificing clarity.',
        localAngle:
      ...
      {
        serviceTitle: 'Ongoing Support & Updates',
        summary: 'Sprint-based improvements for seasonal menus, trunk shows, and service launches.',
        localAngle:
