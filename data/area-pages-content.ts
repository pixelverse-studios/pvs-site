...
const counties: Record<string, CountyContent> = {
  'bergen-county': {
    ...
    name: 'Bergen County',
    state: 'NJ',
    metaTitle: 'Web Design & SEO in Bergen County, NJ',
    metaDescription:
...
const cities: Record<string, CityPageContent> = {
  'fort-lee': {
    ...
    metaTitle: 'Web Design & SEO for Fort Lee, NJ',
    metaDescription:
  ...
  englewood: {
    ...
    county: 'Bergen County',
    countySlug: 'bergen-county',
    metaTitle: 'Web Design & SEO in Englewood, NJ',
    metaDescription:
  ...
  paramus: {
    ...
    county: 'Bergen County',
    countySlug: 'bergen-county',
    metaTitle: 'Web Design & SEO in Paramus, NJ',
    metaDescription:
