...
export const bergenCountyPage: CityServicePageDefinition = {
  ...
  state: 'NJ',
  metadata: {
    title: 'Web Design, SEO & Analytics Agency Bergen County NJ',
    description:
  ...
  proof: {
    headline:
      'A Bergen-first framework built on experience with regulated, retail, and service brands.',
  ...
  faq: [
    ...
    {
      question:
        'Do you handle technical SEO and Google Business Profile management for Bergen clients?',
      answer:
