...
const SERVICE_SLUG = 'ux-ui-design' as const;
const serviceDefinition = getServiceDefinition(SERVICE_SLUG);

/**
 * Generate static params for all cities that have ux-ui-design content
 */
...
export default function UxUiDesignCityPage({ params }: { params: PageParams }) {
