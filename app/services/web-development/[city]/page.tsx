...
const SERVICE_SLUG = 'web-development' as const;
const serviceDefinition = getServiceDefinition(SERVICE_SLUG);

/**
 * Generate static params for all cities that have web-development content
 */
...
export default async function WebDevelopmentCityPage({ params }: { params: Promise<PageParams> }) {
