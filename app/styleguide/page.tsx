...
const brandPalette = [
  ...
  { label: 'Background', token: '--pv-bg', value: '#ffffff / #0a0a0f' },
  { label: 'Surface', token: '--pv-surface', value: '#f7f7fb / #12121a' },
  { label: 'Text', token: '--pv-text', value: '#111111 / #ffffff' },
  { label: 'Muted', token: '--pv-text-muted', value: '#666666 / #b3b3c2' },
  { label: 'Border', token: '--pv-border', value: '#e6e6ef / #1f1f2a' },
