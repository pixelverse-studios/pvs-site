...
- 2025-11-18: Reviewed Search Console “Page with redirect” warnings for `/contact?context=` URLs, confirmed Netlify 301s remain necessary for legacy links, and advised stakeholders to keep promoting the canonical `/contact/<city>` routes until Google drops the old entries.
