...
export function ModalContent({
  ...
  return (
    ...
    >
      ...
      {footer && (
        <DialogFooter className="bg-[var(--pv-surface)]/60 dark:bg-[var(--pv-bg)]/60 flex flex-col gap-3 border-t border-[var(--pv-border)] px-8 py-5 text-sm text-[var(--pv-text-muted)] md:flex-row md:items-center md:justify-between md:text-base">
          {footer}
        </DialogFooter>
      )}
    </DialogContent>
