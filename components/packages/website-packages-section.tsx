    ...
    <section className="py-16 md:py-24">
      <Container className="space-y-10">
        <MotionSection className="space-y-10" as="div">
          ...
          <MotionSection as="div" className="grid grid-cols-1 gap-6 xl:grid-cols-3" delay={0.12}>
                  ...
                  <div className="flex flex-col items-center gap-3 text-center md:items-end md:text-right">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      <Button variant="cta" className="gap-2" asChild>
                        <Link href={`/contact?package=${enterprisePkg.id}`}>
                          Get Started <ArrowRight className="h-4 w-4" />
                        </Link>
                      </Button>
                      <Button variant="ghost" onClick={() => handleOpen(enterprisePkg)}>
                        Learn More
                      </Button>
                    </div>
                  </div>
