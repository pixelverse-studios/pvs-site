            ...
            {websitePackagesData.map((pkg, index) => {
              ...
              return (
                ...
                >
                  <Card
                    id={pkg.id}
                    className="bg-[var(--pv-bg)]/95 dark:bg-[var(--pv-surface)]/95 group relative flex h-full flex-col overflow-visible border border-[var(--pv-border)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--pv-primary)] hover:shadow-[0_26px_60px_-40px_rgba(63,0,233,0.75)]"
                  >
