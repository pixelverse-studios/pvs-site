    ...
    <section className="py-16 md:py-24">
      <Container className="space-y-10">
        <MotionSection className="space-y-10" as="div">
          ...
          <MotionSection
            as="div"
            className="flex gap-6 overflow-x-auto pb-6 md:grid md:grid-cols-2 md:gap-6 md:overflow-visible"
            delay={0.12}
          >
            {websitePackagesData.map((pkg, index) => {
              ...
              return (
                ...
                >
                  <Card
                    id={pkg.id}
                    className="group flex h-full flex-col border border-[var(--pv-border)] bg-[var(--pv-bg)]/95 transition-all duration-300 hover:-translate-y-1 hover:border-[var(--pv-primary)] hover:shadow-[0_26px_60px_-40px_rgba(63,0,233,0.75)] dark:bg-[var(--pv-surface)]/95"
                  >
