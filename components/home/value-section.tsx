  ...
  return (
    <section className="border-b border-[var(--pv-border)] bg-[var(--pv-surface)] dark:bg-[var(--pv-bg)]">
      <Container>
        ...
        <MotionItem delay={0.1} className="relative overflow-hidden rounded-pv border border-[var(--pv-border)] bg-[var(--pv-bg)] p-8 shadow-pv">
          <div
          ...
          <div className="relative space-y-6 text-[var(--pv-text)]">
            ...
            <MotionSection as="div" className="grid gap-4 text-sm text-[var(--pv-text-muted)] sm:grid-cols-2" delay={0.2}>
              <MotionItem className="rounded-pv-sm border border-[var(--pv-border)] bg-[var(--pv-surface)]/90 p-4">
              ...
              <MotionItem delay={0.08} className="rounded-pv-sm border border-[var(--pv-border)] bg-[var(--pv-surface)]/90 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--pv-text-muted)]">
                  Retention Lift
                </p>
