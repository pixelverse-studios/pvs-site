        ...
        <MotionSection as="div" className="space-y-12">
          ...
          <MotionItem className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-[var(--pv-text-muted)]">
              Clear process, no surprises. Every project follows the same proven framework.
            </p>
          </MotionItem>
          ...
          >
            {processSteps.map((step, index) => (
              ...
              >
                {/* Process Card */}
                <div className="group relative flex flex-col items-center space-y-4 rounded-pv border border-[var(--pv-border)] bg-[var(--pv-surface)] p-6 text-center shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-pv">
                  {/* Numbered Badge */}
