    ...
    <section className="py-16 md:py-24">
      <Container>
        <div className="relative overflow-hidden rounded-pv-lg border border-[var(--pv-border)] bg-[linear-gradient(135deg,rgba(63,0,233,0.08),rgba(201,71,255,0.06))] p-[1px]">
          <div className="rounded-[inherit] bg-[var(--pv-bg)]/90 p-8 shadow-[0_40px_90px_-60px_rgba(63,0,233,0.65)] backdrop-blur-sm dark:bg-[var(--pv-surface)]/90">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-4">
              {steps.map((step, index) => (
                <div
                  key={step.title}
                  className="group rounded-pv border border-transparent bg-[var(--pv-surface)]/70 p-6 text-center shadow-[0_18px_40px_-36px_rgba(63,0,233,0.55)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--pv-primary)] hover:shadow-[0_30px_60px_-40px_rgba(63,0,233,0.75)] dark:bg-[var(--pv-bg)]/60"
                >
