      ...
      <Container className="mx-auto max-w-5xl">
        ...
        >
          ...
          <MotionItem delay={0.18}>
            <div className="bg-[var(--pv-surface)]/70 dark:bg-[var(--pv-surface)]/80 space-y-6 rounded-pv border border-[var(--pv-border)] p-6 shadow-[0_24px_60px_-40px_rgba(63,0,233,0.35)]">
