...
export function CityServicesProofSection({ proof, city }: CityServicesProofSectionProps) {
  ...
  const statCard = (
    <MotionItem
      delay={0.16}
      className="flex items-baseline gap-4 rounded-pv border border-[var(--pv-primary)]/40 bg-[linear-gradient(135deg,rgba(63,0,233,0.08),rgba(201,71,255,0.05))] px-6 py-5 shadow-[0_24px_60px_-40px_rgba(63,0,233,0.45)]"
    >
      ...
      <section className="py-16 md:py-24">
        <Container className="grid gap-12 lg:grid-cols-[minmax(0,1.25fr),minmax(0,1fr)] lg:items-center">
          ...
          <MotionItem delay={0.2}>
            <blockquote className="space-y-4 rounded-pv border border-[var(--pv-border)] bg-[var(--pv-surface)]/80 p-6 text-[var(--pv-text-muted)] shadow-[0_24px_60px_-40px_rgba(63,0,233,0.4)] dark:bg-[var(--pv-surface)]/90">
              <p className="text-lg leading-8">&ldquo;{proof.testimonial?.quote}&rdquo;</p>
              <footer className="text-sm uppercase tracking-[0.18em] text-[var(--pv-text-muted)]/80">
    ...
    <section className="py-16 md:py-24">
      <Container className="gap-12 lg:grid lg:max-w-5xl lg:grid-cols-2 lg:items-center">
        ...
        <MotionItem delay={0.18} className="flex justify-center lg:justify-end">
          <div className="w-full max-w-sm rounded-pv border border-[var(--pv-primary)]/40 bg-[linear-gradient(135deg,rgba(63,0,233,0.08),rgba(201,71,255,0.05))] px-6 py-5 text-left shadow-[0_24px_60px_-40px_rgba(63,0,233,0.45)]">
            <span className="font-heading text-5xl font-semibold text-[var(--pv-primary)]">
              {proof.stat.value}
            </span>
