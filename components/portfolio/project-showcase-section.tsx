        ...
        <MotionSection as="div" className="grid gap-6 md:grid-cols-3" delay={0.12}>
          {projects.map((project, index) => (
            <MotionItem
              ...
              className="h-full"
            >
              <Card className="group flex h-full flex-col overflow-hidden border border-[var(--pv-border)] bg-[var(--pv-bg)]/95 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[var(--pv-primary)] hover:shadow-pv dark:bg-[var(--pv-surface)]/95">
                <div
