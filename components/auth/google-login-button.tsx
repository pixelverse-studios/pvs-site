...
export function GoogleLoginButton() {
  ...
  return (
    <div className="group relative">
      ...
      <div className="absolute -inset-[2px] rounded-xl bg-gradient-to-r from-[var(--pv-primary)] via-purple-600 to-[var(--pv-primary-2)] opacity-0 blur-sm transition-all duration-500 group-hover:opacity-20 dark:group-hover:opacity-30" />
