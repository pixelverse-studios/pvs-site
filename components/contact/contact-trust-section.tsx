...
export function ContactTrustSection() {
  return (
    <section className="py-16 md:py-24">
      <Container className="bg-[var(--pv-surface)]/85 dark:bg-[var(--pv-bg)]/80 relative overflow-hidden rounded-pv border border-[var(--pv-border)] px-6 py-12 text-center shadow-[0_30px_60px_-45px_rgba(63,0,233,0.65)] md:px-12">
        <MotionSection as="div" className="space-y-6">
          <MotionItem
            className="absolute inset-x-0 top-0 h-1 bg-[var(--pv-gradient)]"
            aria-hidden
          />
