    ...
    <section className="py-16 md:py-24">
      <Container className="grid gap-6 md:grid-cols-3">
        <MotionSection as="div" className="md:col-span-2" delay={0.08}>
          <MotionItem className="relative rounded-[1.5rem] bg-[var(--pv-gradient)] p-[1px] shadow-[0_30px_70px_-45px_rgba(63,0,233,0.75)]" triggerOnViewport={false}>
            ...
            <Card className="bg-[var(--pv-surface)]/90 dark:bg-[var(--pv-bg)]/85 border border-[var(--pv-border)] p-6 shadow-pv transition hover:-translate-y-1 hover:border-[var(--pv-primary)]">
              ...
              <CardContent className="mt-4 p-0">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-base font-medium text-[var(--pv-primary)] hover:text-[var(--pv-primary-2)]"
                >
