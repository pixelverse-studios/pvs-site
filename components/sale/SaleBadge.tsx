...
const variantStyles: Record<BadgeVariant, string> = {
  ...
  primary:
    'bg-gradient-to-r from-[var(--pv-primary)] to-[var(--pv-primary-2)] shadow-[0_4px_14px_-4px_rgba(63,0,233,0.5)]',
};

export function SaleBadge({ packageId, text, variant, className = '' }: SaleBadgeProps) {
...
export function SaleBadgeWrapper({ packageId, children, className = '' }: SaleBadgeWrapperProps) {
  return (
