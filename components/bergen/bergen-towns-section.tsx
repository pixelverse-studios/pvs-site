...
const towns = [
  ...
  },
  {
    ...
    highlights: [
      'Premium brand system & Manhattan-grade visuals',
      'Cross-Hudson SEO with conversion analytics',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Service landing clusters + booking flows',
      'Review prompts & GBP optimization at scale',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Promo + product landing templates',
      'Dashboards tying in-store and digital conversions',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Service area pages with persona storytelling',
      'GA4 segmentation by neighborhood + campaign',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Multilingual-ready UX + ADA compliance baked in',
      'Analytics tying community + campus referrals to leads',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Industrial + residential landing variants',
      'CRM + dispatch-integrated intake automation',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Editorial-grade UI with decisive CTAs',
      'Local SEO + schema for hospital, retail, and HQ launches',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Bilingual trust frameworks + review loops',
      'Hyperlocal analytics by neighborhood and channel',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Boutique UX components + premium storytelling',
      'Attribution tying Ridgewood Guild events to bookings',
    ],
