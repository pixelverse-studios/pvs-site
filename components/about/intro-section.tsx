  ...
  return (
    <section className="bg-[var(--pv-surface)] pt-hero pb-16 md:pt-hero md:pb-24">
      <Container className="flex max-w-3xl flex-col items-center gap-8 text-center">
        ...
        <div className="flex items-center gap-3 rounded-full border border-[var(--pv-border)] bg-[var(--pv-bg)]/90 px-4 py-2 text-sm text-[var(--pv-text-muted)] shadow-[0_30px_60px_-45px_rgba(63,0,233,0.65)]">
          <span aria-hidden className="h-2 w-2 rounded-full bg-[var(--pv-primary)]" />
          <span>Strategy-led builds, engineered to move your metrics.</span>
        </div>
      </Container>
    </section>
  );
