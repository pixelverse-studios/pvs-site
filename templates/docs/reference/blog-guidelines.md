...
**When to reference this file:** Before writing or editing any blog post, article, or long-form content.
...
- Anchor every post to **one primary keyword cluster**
...
- **Lead with intent**: Open with what the reader came for
...
- Hook readers in the **first 100 words** with a compelling promise or problem statement
...
- Deliver **original insights** not found in competitor content
...
- Close with a **concrete next step** (contact, download, related read)
...
- Include **FAQ schema** when posts contain Q&A sections
...
1. Review Search Console queries driving traffic to each post
2. Analyze scroll depth and time on page
3. Track CTA click-through rates
4. Identify posts with declining traffic
...
- Word count: 800+ words for standard posts, 1,500+ for pillar content
...
**File Owner:** Content Lead
**Version:** v1.0
**Purpose:** Maintain consistent, high-quality blog content across all projects.
